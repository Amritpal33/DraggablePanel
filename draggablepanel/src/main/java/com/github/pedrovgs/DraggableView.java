...
public class DraggableView extends RelativeLayout {
    ...
    /**
     * Configure the horizontal scale factor applied when the view is dragged to the bottom of the custom view.
     *
     * @param xScaleFactor
     */
    ...
    /**
     * Configure the vertical scale factor applied when the view is dragged to the bottom of the custom view.
     *
     * @param yScaleFactor
     */
    ...
    /**
     * Configure the DraggableListener notified when the view is minimized, maximized, closed to the right or closed
     * to the left.
     *
     * @param listener
     */
    ...
    /**
     * Modify dragged view alpha based on the horizontal position while the view is being horizontally dragged.
     */
